...
import { Home, AlertTriangle, Shield, FileText, Settings, LogOut, Moon, Sun, Calendar, CheckSquare, BarChart, X, Building, Activity, Bot } from 'lucide-react';
    ...
    <>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          <Link to="/home" onClick={onClose}><Home /> <span>Hem</span></Link>
          ...
          <Link to="/company" onClick={onClose}><Building /> <span>Företag</span></Link>
